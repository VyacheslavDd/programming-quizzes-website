...
namespace ProgQuizWebsite.Migrations
{
    ...
    [Migration("20240828123103_reset password requests")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProgQuizWebsite.Domain.Users.Models.ResetPasswordRequests.ResetPasswordRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProgQuizWebsite.Domain.Users.Models.UserConfirm.UserConfirmation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ProgQuizWebsite.Domain.Users.Models.ResetPasswordRequests.ResetPasswordRequest", b =>
                {
                    b.HasOne("ProgQuizWebsite.Domain.Users.Models.UserModel.User", "User")
                        .WithOne("ResetPasswordRequest")
                        .HasForeignKey("ProgQuizWebsite.Domain.Users.Models.ResetPasswordRequests.ResetPasswordRequest", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProgQuizWebsite.Domain.Users.Models.UserConfirm.UserConfirmation", b =>
                {
                    b.HasOne("ProgQuizWebsite.Domain.Users.Models.UserModel.User", "User")
                        .WithOne("UserConfirmation")
                        .HasForeignKey("ProgQuizWebsite.Domain.Users.Models.UserConfirm.UserConfirmation", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProgQuizWebsite.Domain.Users.Models.UserModel.User", b =>
                {
                    ...
                    b.Navigation("ResetPasswordRequest");
